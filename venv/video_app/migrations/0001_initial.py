# Generated by Django 3.2.8 on 2024-07-23 00:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('video', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='video_app.video')),
            ],
        ),
        migrations.CreateModel(
            name='ShareLink',
            fields=[
                ...
                ('video_page', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='video_app.videopage')),
            ],
        ),
    ]
